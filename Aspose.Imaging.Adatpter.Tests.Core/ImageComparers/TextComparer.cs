...
namespace Aspose.Imaging.Pdf.Adapter.Tests.ImageComparers
{
    ...
    public class TextComparer : BaseComparer
    {
        #region Fields
        ...
        /// <param name="referenceStream">The etalon stream.</param>
        /// <returns>The compare result</returns>
        public override CompareResult CompareStreams(Stream compareStream, Stream referenceStream)
        {
            ...
            var reference = new StreamReader(referenceStream, Encoding.UTF8);
            var lineId = 1;
